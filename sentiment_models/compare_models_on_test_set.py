...
models = [Baseline(), GerVADER(), SpacySentiWS(), TextBlob(), VaderSentiWS(), Vader(),
...
if __name__ == "__main__":
	...
	for current_model in models:
		currently_predicted_labels = [current_model.get_sentiment_label(tweet["text"]) for tweet in input_data]
